...
public class TForwardList<E> implements InterForwardList<E> {
    ...
    //do zadania 2 Laboratorium nr 4. Lista jednokierunkowa
    //a
    @Override
    ...
    public E get(int index) {
        ...
        int ind = 0;
        while(tmp != null){
            if(ind == index) return tmp.getData();
            else{
                tmp = tmp.getNext();
                ind++;
            }
    ...
    public void printAsArray(){
        ...
        int ind=0;
        while(tmp!=null){
            System.out.println("list["+ind+"]="+tmp.getData());
            ind++;
        }
    }
}
